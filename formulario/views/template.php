...
<head>
  ...
  <link rel="icon" type="image/png" href="views/img/logoscan.jpg"/>
...
/// Elementos de li
const tabs = ["estacioncalidad", "unidadalimentacion","tabla","unidadaceleracion","unidaddescarga","bandas","paletas","sprockets","vdf","automatico","registros","rodamientos","sensor","unidadpesaje","tableroelectrico","fuentepoder","plc","manifold","tableroneumatico","clientes","cilindros","motor","grader","suscriptores","historialvisitas"];
tabs.forEach(e => {
