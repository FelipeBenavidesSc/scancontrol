...
echo '<option value="'.$value["id_vdf"].'">Potencia: '.$value["potencia"].' / Marca: ' .$value["marca"].'</option>';
 ...
 ?>
    ...
    <div class="form-group row" style="margin-bottom: 15px;">
            ...
            <label class="col-2 col-sm-2 col-form-label" id="largo">Enchufe Modelo:</label>
            <div class="col-4 col-sm-4">  
           <input type="text" class="form-control" placeholder="Modelo" name="EnchufeModelo[]">
            </div>
            <label class="col-1 col-sm-1 col-form-label" id="largo">Amperaje</label>
  <div class="col-4 col-sm-4">  
           <input type="text" class="form-control" placeholder="Amperaje" name="EnchufeAmperaje[]">
            </div>

            <div class="col-1 col-sm-1">
              <button style="margin-bottom: 2px" type="button" name="agregarenchufe" id="agregarenchufe" class="btn btn-info" >+</button>
            </div>
          </div>
          <div id="dinamienchufe" ></div>
    <div class="form-group row" style="margin-bottom: 15px;">
                
            <label class="col-2 col-sm-2 col-form-label" id="largo">Prensas Modelo:</label>
            <div class="col-4 col-sm-4">  
           <input type="text" class="form-control" placeholder="Modelo" name="PrensasModelo[]">
            </div>
            <label class="col-1 col-sm-1 col-form-label" id="largo">Cantidad</label>
  <div class="col-4 col-sm-4">  
           <input type="text" class="form-control" placeholder="Cantidad" name="PrensasCantidad[]">
            </div>

            <div class="col-1 col-sm-1">
              <button style="margin-bottom: 2px" type="button" name="agregarprensas" id="agregarprensas" class="btn btn-info" >+</button>
            </div>
          </div>
          <div id="dinamiprensas" ></div>
    ...
    <div class="form-group row">
            <label class="col-sm-2 col-form-label">Nombre Botoneras Partir/Parar</label>
            <div class="col-sm-10">
               <input type="text" class="form-control" placeholder="Nombre Botoneras" name="Botoneras">
            </div>
          </div>
   

    <div class="form-group row">
            <label class="col-sm-2 col-form-label">Marca Switch</label>
            <div class="col-sm-4">
               <input type="text" class="form-control" placeholder="Marca Switch" name="MarcaSwitch">
            </div>
              <label class="col-sm-2 col-form-label">Puerto Switch</label>
            <div class="col-sm-4">
               <input type="text" class="form-control" placeholder="Puerto Switch" name="PuertoSwitch">
            </div>
          </div>
             <div class="form-group row">
            <label class="col-sm-2 col-form-label">Main Switch Modelo</label>
            <div class="col-sm-10">
               <input type="text" class="form-control" placeholder="Main Switch Modelo" name="MainSwitch">
            </div>
          </div>
              <div class="form-group row">
            <label class="col-sm-2 col-form-label">Botonera Parada de Emergencia Modelo</label>
            <div class="col-sm-10">
               <input type="text" class="form-control" placeholder="Modelo" name="ModeloEmergencia">
            </div>
          </div>
...
<div class="col-1 col-sm-9">
               ...
               <div class="col-1 col-sm-2">
    <button style="margin-bottom: 2px" type="button" name="editarenchufe" id="editarenchufe" class="btn btn-info" >Agregar Enchufe +</button>
            </div>
            </div> 
 <div id="dinamienchufeeditar" style="margin-bottom: 0px;">
    
 </div>
 <div id="enchufeeditar" style="margin-bottom: 0px;">  
 </div>
     <div class="form-group row">
<div class="col-1 col-sm-9">
               ...
               <div class="col-1 col-sm-2">
    <button style="margin-bottom: 2px" type="button" name="editarprensas" id="editarprensas" class="btn btn-info" >Agregar Prensas +</button>
            </div>
            </div> 
 <div id="dinamiprensaseditar" style="margin-bottom: 0px;">
    
 </div>
 <div id="prensaseditar" style="margin-bottom: 0px;">  
 </div>
...
var h=1; 
 $('#agregarenchufe').click(function(){
        h++;
 $('#dinamienchufe').append('<div id="row4'+h+'" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Enchufe Modelo:</label><div class="col-4 col-sm-4"><input type="text" class="form-control" placeholder="Modelo" name="EnchufeModelo[]"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Amperaje</label><div class="col-3 col-sm-4">  <input type="text" class="form-control" placeholder="Amperaje" name="EnchufeAmperaje[]"> </div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+h+'" class="btn btn-danger btn_remove5" >X</button></div></div>');
    });
...
var pre=1; 
 $('#agregarprensas').click(function(){
        pre++;
 $('#dinamiprensas').append('<div id="row5'+pre+'" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Prensas Modelo:</label><div class="col-4 col-sm-4"><input type="text" class="form-control" placeholder="Modelo" name="PrensasModelo[]"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Cantidad</label><div class="col-3 col-sm-4">  <input type="text" class="form-control" placeholder="Cantidad" name="PrensasCantidad[]"> </div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+pre+'" class="btn btn-danger btn_remove6" >X</button></div></div>');
    });
...
<script type="text/javascript">
    ...
    var datos = new FormData()
    datos.append("id_tableroelectrico", idTableroelectrico)
    datos.append("tipoOperacion", "editarTableroenchufe")
    $.ajax({
      url: 'ajax/ajaxTableroelectrico.php',
      type: 'POST',
      data: datos,
...
var size = valor.length;
 if($('#dinamienchufeeditar').find("#row").length){
 $("#dinamienchufeeditar").empty()
}
 for(x=0; x<size; x++){

 $('#dinamienchufeeditar').append('<div id="row" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Enchufe Modelo:</label><div class="col-4 col-sm-4"><input type="hidden" name="idEnchufe[]" value="'+valor[x][0]+'"><input type="text" class="form-control" placeholder="Modelo" name="EnchufeModelo[]" value="'+valor[x][2]+'"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Amperaje</label><div class="col-3 col-sm-4"> <input type="text" class="form-control" placeholder="Amperaje" name="EnchufeAmperaje[]" value="'+valor[x][3]+'"></div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+x+'" class="btn btn-danger btn_remove5 Eliminar_enchufe"   idEnchufe="'+valor[x][0]+'">X</button></div></div></div>');
...
var j=1; 
 $('#editarenchufe').click(function(){
        j++;
 $('#enchufeeditar').append('<div id="row5'+j+'" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Enchufe Modelo:</label><div class="col-4 col-sm-4"><input type="text" class="form-control" placeholder="Modelo" name="EnchufeModeloEditar[]"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Amperaje</label><div class="col-3 col-sm-4"><input type="text" class="form-control" placeholder="Amperaje" name="EnchufeAmperajeEditar[]"></div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+j+'" class="btn btn-danger btn_remove5" >X</button></div></div>');
...
<script type="text/javascript">
    ...
    var datos = new FormData()
    datos.append("id_tableroelectrico", idTableroelectrico)
    datos.append("tipoOperacion", "editarTableroprensas")
    $.ajax({
      url: 'ajax/ajaxTableroelectrico.php',
      type: 'POST',
      data: datos,
...
var size = valor.length;
 if($('#dinamiprensaseditar').find("#row").length){
 $("#dinamiprensaseditar").empty()
}
 for(x=0; x<size; x++){

 $('#dinamiprensaseditar').append('<div id="row" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Prensas Modelo:</label><div class="col-4 col-sm-4"><input type="hidden" name="idPrensas[]" value="'+valor[x][0]+'"><input type="text" class="form-control" placeholder="Modelo" name="PrensasModelo[]" value="'+valor[x][2]+'"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Cantidad</label><div class="col-3 col-sm-4"> <input type="text" class="form-control" placeholder="Cantidad" name="PrensasCantidad[]" value="'+valor[x][3]+'"></div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+x+'" class="btn btn-danger btn_remove6 Eliminar_prensas"   idPrensas="'+valor[x][0]+'">X</button></div></div></div>');
...
var j=1; 
 $('#editarprensas').click(function(){
        j++;
 $('#prensaseditar').append('<div id="row5'+j+'" class="form-group row" style="margin-bottom:15px;"> <label class="col-2 col-sm-2 col-form-label" id="largo">Prensas Modelo:</label><div class="col-4 col-sm-4"><input type="text" class="form-control" placeholder="Modelo" name="PrensasModeloEditar[]"></div><label class="col-1 col-sm-1 col-form-label" id="largo">Cantidad</label><div class="col-3 col-sm-4"><input type="text" class="form-control" placeholder="Cantidad" name="PrensasCantidadEditar[]"></div><div class="col-1 col-sm-1"><button type="button" name="remove" id="'+j+'" class="btn btn-danger btn_remove6" >X</button></div></div>');
