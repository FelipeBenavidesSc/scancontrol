  ...
  <tbody>
   <tr>
      ...
      <td>
                              <?php
      if($value["imgcalidad"]==''){
 echo '<img  width="400" src="views/img/sinimagen.jpg"/>'; 
      }else{
      ?> 

       <a href="<?php substr($value["imgcalidad"], 3) ?>"><img  width="400" src="<?php echo substr($value["imgcalidad"], 3) ?>" ></a>
 <?php }?> 
     </td>
    </tr>
  </tbody>
...
<h5>Imagen </h5>
  ...
  <tbody>
   <tr>
      ...
      if($value["alimentacionimg"]==''){
  echo'<img  width="400" src="views/img/sinimagen.jpg"/>'; 
      }else{
      
       echo'<a href="'.substr($value["alimentacionimg"], 3).'"><img  width="400" src="'.substr($value["alimentacionimg"], 3).'" ></a>';
     }
     echo'</td>
    </tr>
  </tbody>
...
<h5>Imagen </h5>
  ...
  <tbody>
   <tr>
      ...
      <td>';
          if($value["imgaceleracion"]==''){
  echo'<img  width="400" src="views/img/sinimagen.jpg"/>'; 
      }else{
     echo'  <a href="'.substr($value["imgaceleracion"], 3).'"><img  width="400" src="'.substr($value["imgaceleracion"], 3).'" ></a>';
   }
   echo'</td>
    </tr>
  </tbody>
...
<h5>Imagen </h5>
  ...
  <tbody>
   <tr>
      ...
      <td>';
                if($value["descargaimg"]==''){
  echo'<img  width="400" src="views/img/sinimagen.jpg"/>'; 
      }else{
      echo' <a href="'.substr($value["descargaimg"], 3).'"><img  width="400" src="'.substr($value["descargaimg"], 3).'" ></a>';
    }
    echo'
      </td>
    </tr>
...
<table class="table table-bordered" style="background: #d3d3ff; text-align:center;">
  ...
  echo'<img  width="400" src="views/img/sinimagen.jpg"/>'; 
      ...
      echo' <a href="'.substr($value["imgpesaje"], 3).'"><img  width="400" src="'.substr($value["imgpesaje"], 3).'" ></a>';
    }
      echo'</td>
    </tr>
  </tbody>
