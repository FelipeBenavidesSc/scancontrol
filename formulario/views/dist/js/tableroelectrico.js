...
$('#formu-editar-tableroelectrico input[name="MarcaSwitch"]').val(valor.marcaswitch)
$('#formu-editar-tableroelectrico input[name="PuertoSwitch"]').val(valor.puertoswitch)
$('#formu-editar-tableroelectrico input[name="ModeloEmergencia"]').val(valor.modeloemergencia)
$('#formu-editar-tableroelectrico input[name="Botoneras"]').val(valor.botoneras)
$('#formu-editar-tableroelectrico input[name="MainSwitch"]').val(valor.mainswitch)
...
$("body #dinamienchufeeditar").on("click", ".Eliminar_enchufe", function(){
		var idEnchufe = $(this).attr("idEnchufe")


		var datos = new FormData()
		datos.append("id_enchufe", idEnchufe)
		datos.append("tipoOperacion", "eliminarTenchufe")
	console.log(idEnchufe)
		Swal.fire({
		    width: 400,
		  padding:'2em',
		  text: "Estas seguro de eliminar!",
...
$("body #dinamiprensaseditar").on("click", ".Eliminar_prensas", function(){
		var idPrensas = $(this).attr("idPrensas")


		var datos = new FormData()
		datos.append("id_prensas", idPrensas)
		datos.append("tipoOperacion", "eliminarTprensas")
