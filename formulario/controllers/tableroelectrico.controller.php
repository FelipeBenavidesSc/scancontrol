...
Class ControllerTableroelectrico {
	public function listarTableroelectricoCtr() {
		...
		return $respuesta;
				...
				public function listarTelectricoenchufeCtr() {
		$tabla = "telectrico_enchufes";
		$respuesta = ModeloTableroelectrico::listarTelectricoenchufeMdl($tabla);
		return $respuesta;
	}
				public function listarTelectricoprensasCtr() {
		$tabla = "telectrico_prensas";
		$respuesta = ModeloTableroelectrico::listarTelectricoprensasMdl($tabla);
		return $respuesta;
	}
...
list($ancho, $alto) = getimagesize($datos["imagen"]["tmp_name"]);
	...
	static public function ctrEliminarTautomatico($id_tautomatico) {
		...
		static public function ctrEliminarTenchufe($id_tenchufe) {
		$tabla = "telectrico_enchufes";
		$respuesta = ModeloTableroelectrico::mdlEliminarTenchufe($tabla, $id_tenchufe);
		return $respuesta;
	}
		static public function ctrEliminarTprensas($id_tprensas) {
		$tabla = "telectrico_prensas";
		$respuesta = ModeloTableroelectrico::mdlEliminarTprensas($tabla, $id_tprensas);
		return $respuesta;
	}
	static public function ctrEditarTableroelectrico($id_tableroelectrico) {
		...
		static public function ctrEditarTableroenchufe($id_tableroelectrico) {
		$tabla = "telectrico_enchufes";
		$respuesta = ModeloTableroelectrico::mdlEditarTableroenchufe($tabla, $id_tableroelectrico);
		return $respuesta;
	}
		static public function ctrEditarTableroprensas($id_tableroelectrico) {
		$tabla = "telectrico_prensas";
		$respuesta = ModeloTableroelectrico::mdlEditarTableroprensas($tabla, $id_tableroelectrico);
		return $respuesta;
	}
