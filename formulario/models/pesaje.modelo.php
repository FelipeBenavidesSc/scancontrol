...
static public function listarPesajeMdl($tabla) {
		$sql = Conexion::conectar()->prepare("SELECT a.id_unidad_pesaje,a.descripcion pesdesc,a.cantidad_sensores,a.cantidad_sprocket,a.medida_banda,a.eje,a.entradaalto,a.entradaancho,a.entradaespesor,a.pesajealto,a.pesajeancho,a.pesajeespesor,a.salidaalto,a.salidaancho,a.salidaespesor,a.rutaImg imgpesaje,se.id_sensor,se.tipo_sensor,se.marca marcasensor,se.modelo modelosensor,se.voltaje voltajesensor,se.distancia distanciasensor,se.contacto contactosensor,se.rutaImg imgsensor,s.id_sprockets,s.serie seriesprockets,s.modelo modelosprockets,s.dientes dientessprockets,s.perforacion perforacionsprockets,s.descripcion descripcionsprockets,s.rutaImg imgsprockets,b.id_banda,b.superficie superficiebanda,b.paso pasobanda,b.numero_serie numeroseriebanda,b.descripcion descripcionbanda,b.ancho anchobanda,b.material bandamaterial,b.rutaImg imgbanda,m.id_motor,m.rpm,m.marca marcamotor,m.usillo,m.ancho anchomotor,m.capacidad capacidadmotor,m.rutaImg imgmotor,r.id_rodamientos,r.modelo modelodescanso,r.rodamiento,r.material materialdescanso,r.fijaciones fijacionesdescanso,r.rutaImg imgdescanso,te.id_tableroelectrico,te.altura alturate,te.ancho anchote,te.fondo fondote,te.contactor contactorte,te.marcaswitch marcaswitch,te.puertoswitch puertoswitch,te.modeloemergencia modeloemergencia,te.botoneras botoneraste,te.mainswitch mainswitch,te.rutaImg imgte,tn.id_tableroneumatico,tn.altura alturatn,tn.ancho anchotn,tn.fondo fondotn,tn.rutaImg imgtn  FROM $tabla a LEFT JOIN sprockets s on s.id_sprockets=a.tipo_sprocket  LEFT JOIN bandas b on b.id_banda=a.tipo_banda LEFT JOIN sensor se on se.id_sensor=a.tipo_sensores LEFT JOIN motor m on m.id_motor=a.tipo_motor LEFT JOIN rodamientos r on r.id_rodamientos=a.tipo_rodamientos LEFT JOIN tableroelectrico te on te.id_tableroelectrico=a.tableroelectrico LEFT JOIN tablero_neumatico tn on tn.id_tableroneumatico=a.tableroneumatico");
		$sql -> execute();
		return $sql -> fetchAll();
}
