...
");
	...
	static public function listarregistrosCalidadMdl($registros) {
		$sql = Conexion::conectar()->prepare("SELECT * FROM $registros  where id_unidad IS NULL ORDER BY id_calidad ASC");
		$sql -> execute();
		return $sql -> fetchAll();
	}
		static public function listarregistrosAlimentacionMdl($registros) {
		$sql = Conexion::conectar()->prepare("SELECT * FROM unidad_alim  where id_unidad_al IS NULL ORDER BY id_unidad_alim ASC");
		$sql -> execute();
		return $sql -> fetchAll();
	}
		static public function listarregistrosAceleracionMdl($registros) {
		$sql = Conexion::conectar()->prepare("SELECT * FROM unidad_acel  where id_unidad IS NULL ORDER BY id_unidad_acel ASC");
		$sql -> execute();
		return $sql -> fetchAll();
	}
		static public function listarregistrosPesajeMdl($registros) {
		$sql = Conexion::conectar()->prepare("SELECT * FROM unidad_pesaje  where id_unidad IS NULL ORDER BY id_unidad_pesaje ASC");
		$sql -> execute();
		return $sql -> fetchAll();
	}
			static public function listarregistrosDescargaMdl($registros) {
		$sql = Conexion::conectar()->prepare("SELECT * FROM unidad_descarga  where id_unidad IS NULL ORDER BY id_unidad_descarga ASC");
		$sql -> execute();
		return $sql -> fetchAll();
	}
